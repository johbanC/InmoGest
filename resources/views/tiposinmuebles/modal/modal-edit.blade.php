            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nombre" class="form-control parsley-success {{ $errors->has('nombre') ? 'is-invalid' : '' }}" value="{{ old('nombre', isset($tiposinmueble) ? $tiposinmueble->nombre : '') }}" id="input-nombre" autofocus value="{{ old('nombre') }}" required="" placeholder="Tipo de propiedad" data-parsley-id="5" id="input-nombre" autofocus >
