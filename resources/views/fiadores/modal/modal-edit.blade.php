<!-- Modal para editar fiador -->
<div class="modal fade modalEditar{{ $cliente->id }}" tabindex="-1" role="dialog"
    aria-labelledby="modalEditarFiadorLabel{{ $cliente->id }}" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form id="formularioEditarFiador{{ $cliente->id }}" method="POST"
            action="{{ route('fiadores.update', $cliente) }}">
            @csrf
            @method('PUT')
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalEditarFiadorLabel{{ $cliente->id }}">Editar Fiador</h5>
