                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-end align-items-center">
                            <div class="card-tools">
                                ...
                                @include('inquilinos.modal.modal-nuevo', [
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                            ...
                            <tbody>
                                @foreach ($clientes as $index => $cliente)
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                    <a class="dropdown-item"
                                                        href="{{ route('inquilinos.show', $cliente->id) }}">
                                                    ...
                                                    <form action="{{ route('inquilinos.destroy', $cliente->id) }}"
                                    ...
                                    @include('inquilinos.modal.modal-edit')
                                @endforeach
                            </tbody>
                        </table>
                    </div>
    ...
    @section('scripts')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                var formulario = document.getElementById("FormularioCrearInquilino");
