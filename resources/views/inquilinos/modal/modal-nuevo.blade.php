...
<!-- Modal content for Nuevo Inquilino -->
<div class="modal fade bs-example-modal-lg" id="modalNuevoInquilino" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="FormularioCrearInquilino" method="POST" action="{{ route('inquilinos.store') }}"
                class="needs-validation" novalidate enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title" id="myLargeModalLabel">Nuevo Inquilino</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="nombre"
                                    ...
                                    id="input-nombre" placeholder="Nombre del Inquilino" value="{{ old('nombre') }}"
                                    required>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="apellido"
                                    ...
                                    id="input-apellido" placeholder="Apellido del Inquilino"
...
<script>
    $(document).ready(function() {
        $('#modalNuevoInquilino').on('shown.bs.modal', function() {
