                                 ...
                                 <div class="row">
                                     <div class="col-md-4">
                                         ...
                                         @if ($firmaEntrega || $firmaRecibe)
                                             <br>
                                             <a href="{{ route('certificados.show', $inventario->id) }}"
                                                 class="btn btn-info" target="_blank">Certificado Hash de firma digital</a>
                                         @endif
                                     </div>
                                     ...
                                     <div class="col-md-4">
                                         <div class="card-tools">
                                             @if ($firmaRecibe)
                                                 <button type="button" class="btn btn-secondary waves-effect waves-light"
                                                     data-bs-toggle="modal"
                                                     data-bs-target=".bs-example-modal-lg-ver-recibe">
                                                             ...
                                                             <table class="table">
                                                                 <thead>
                                                                     <tr>
                                                                         ...
                                                                         <th class="text-center"><strong>Cantidad</strong>
                                                                         </th>
                                                                         <th class="text-center"><strong>Material</strong>
                                                                         </th>
                                                                 ...
                                                                 <tbody>
                                                                     @foreach ($area->items as $item)
                                                                         <tr>
                                                                             ...
                                                                             <td class="text-center">{{ $item->cantidad }}
                                                                             </td>
                                                                             <td class="text-center">{{ $item->material }}
                                                                             </td>
