...
<!-- Modal content for Nuevo Propietario -->
<div class="modal fade bs-example-modal-lg" id="modalNuevoPropietario" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="FormularioCrearPropietario" method="POST" action="{{ route('propietarios.store') }}"
                class="needs-validation" novalidate enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title" id="myLargeModalLabel">Nuevo Propietario</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="nombre"
                                    ...
                                    id="input-nombre" placeholder="Nombre del Propietario" value="{{ old('nombre') }}"
                                    required>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="apellido"
                                    ...
                                    id="input-apellido" placeholder="Apellido del Propietario"
...
<script>
    $(document).ready(function() {
        $('#modalNuevoPropietario').on('shown.bs.modal', function() {
