...
<div class="modal fade modalEditar{{ $cliente->id }}" tabindex="-1" role="dialog"
    aria-labelledby="modalEditarPropietarioLabel{{ $cliente->id }}" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form id="formularioEditarPropietario{{ $cliente->id }}" method="POST"
            action="{{ route('propietarios.update', $cliente) }}">
            @csrf
            @method('PUT')
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalEditarPropietarioLabel{{ $cliente->id }}">Editar Propietario</h5>
