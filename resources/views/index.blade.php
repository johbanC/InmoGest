...
@section('body') <body data-sidebar="dark"> @endsection
    ...
    <div class="card mini-stat bg-info text-white">
        <div class="card-body">
            <div class="mb-4">
                <div class="float-start mini-stat-img me-4">
                    <i class="mdi mdi-harddisk" style="font-size: 2.5rem;"></i>
                </div>
                <h5 class="font-size-16 text-uppercase text-white-50">Espacio en Disco</h5>
                <h4 class="fw-medium font-size-24">
                    {{ $espacioLibreGB }} GB / {{ $espacioTotalGB }} GB
                </h4>
                <div class="mini-stat-label bg-success">
                    <p class="mb-0">Libre: {{ $espacioLibreGB }} GB</p>
                </div>
            </div>
        </div>
    </div>
