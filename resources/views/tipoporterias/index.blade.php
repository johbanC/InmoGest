...
@section('title') Tipo de Porterias @endsection
...
@slot('page_title') Tipo de Porterias @endslot
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-xs btn-default text-primary mx-1 shadow" data-bs-toggle="modal" data-bs-target=".modalEditar{{ $tipoporteria->id }}"><i class="fa fa-lg fa-fw fa-pen"></i></button>
